...
public class OrganizationActivity extends AppCompatActivity {
    ...
    public void initOrganizations() {
        ...
        organizationRef.push().setValue(new Organization("Soda Foundation", "We make soda, lots of soda.\nSoda for the rich, soda for the poor", "01120141336", "weeb@trap.con", "www.google.com", 0, R.drawable.city));
        organizationRef.push().setValue(new Organization("Chicken Foundation", "We fight against the cruelty shown by humans against chickens.\nEveryday, 2 million chickens are murdered in cold blood while humans get away scot free.", "01120141336", "weeb@trap.con", "www.google.com", 0, R.drawable.city));
        organizationRef.push().setValue(new Organization("Potato Foundation", "Even potatoes are human", "01120141336", "weeb@trap.con", "www.google.com", 0, R.drawable.city));
        organizationRef.push().setValue(new Organization("Nyanko Foundation","Nya nya nya nya nya nya nya nya nya.\nNya nya nya nya nya nya nya nya nya nya nya nya nya nya nya nya!", "01120141336", "weeb@trap.con", "www.google.com", 0, R.drawable.city));
    }
