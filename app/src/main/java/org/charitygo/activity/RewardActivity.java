...
public class RewardActivity extends AppCompatActivity {
    ...
    private void getRewards(){
        rewardList.add(new Reward("Reward 1", R.drawable.city));
        rewardList.add(new Reward("Reward 2", R.drawable.city));
        rewardList.add(new Reward("Reward 3", R.drawable.city));
        rewardList.add(new Reward("Reward 4", R.drawable.city));
        rewardList.add(new Reward("Reward 5", R.drawable.city));
        rewardList.add(new Reward("Reward 6", R.drawable.city));
    }
